...
/**
 * It is a copy-paste, only MarkdownElementType.platformType(node.type) is changed to MdxElementType.platformType(node.type)
 *
 * @see org.intellij.plugins.markdown.lang.parser.PsiBuilderFillingVisitor
 */

class MdxPsiBuilderFillingVisitor(private val builder: PsiBuilder) : RecursiveVisitor() {
